...
describe('Naive UI Hive 主题', () => {
  it('保持 Hive 强调红主色、紧凑控件和材质化圆角标尺', () => {
    expect(teahouseLightThemeOverrides.common?.primaryColor).toBe('#e94560')
    expect(teahouseDarkThemeOverrides.common?.primaryColor).toBe('#e94560')
