...
.settings::after {
  ...
  z-index: 1000;
  pointer-events: none;
  box-shadow: inset 0 0 0 1px rgba(230, 237, 243, 0.12);
}
...
.sidebar {
  ...
  box-shadow: var(--highlight-edge), 8px 0 24px rgba(0, 0, 0, 0.035);
